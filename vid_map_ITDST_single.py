...
from model.acm_net.ACM import ACMBody #as model 
from model.AGPCNet import AGPCBody #as model
from model.dna_net.test import DNABody #as model

from utils.utils import (cvtColor, get_classes, preprocess_input, resize_image,
                         show_config)
# from model.acm_net.ACM import ACMBody as ACM
...
cocoGt_path         = '/home/public/ITSDT/instances_test2017.json'#'/home/pengshuang/Public/IRDST/IRDST_instances_test2017.json'
dataset_img_path    = '/home/public/ITSDT/'#'/home/pengshuang/Public/IRDST/'
# cocoGt_path         = '/home/public/IRDST/annotations/instances_test2017.json'
# dataset_img_path    = '/home/public/IRDST/'
#-------------------------------------------------------#
#   结果输出的文件夹，默认为map_out
#-------------------------------------------------------# 
temp_save_path      = 'map_out/coco_eval_ST_MultiTime_IRDST_45_final_re'
...
class MAP_vid(object):
    _defaults = {
        ...
        #"model_path"        : 'IRDST/best_IRDST.pth',#'logs/loss_2024_06_03_01_43_33_加入backbone进行预训练v7注意力/ep001-loss3.445-val_loss3.545.pth',#loss_2024_06_01_15_03_19/ep020-loss3.276-val_loss3.286.pth',#best_epoch_weights.pth',#'/home/work/logs/DAUB_F1_98.09.pth', 
        #"model_path"         :"/home/pengshuang/Public/Exper_Results/Exper_Results/ITSDT_results/YOLOX_ITSDT/ep051-loss2.849-val_loss6.077.pth" , #单帧 
       
        "model_path":'/home/pengshuang/Public/Exper_Results/Exper_Results/ITSDT_results/ACM_ITSDT/ep060-loss3.042-val_loss6.144.pth',
        "model_path":'/home/pengshuang/Public/Exper_Results/Exper_Results/ITSDT_results/AGPCNet_ITSDT/ep030-loss2.996-val_loss5.418.pth',
        "model_path":'/home/pengshuang/Public/Exper_Results/Exper_Results/ITSDT_results/DNANet_ITSDT/ep020-loss2.982-val_loss5.162.pth',
        "model_path"         :"/home/pengshuang/Public/Exper_Results/Exper_Results/ITSDT_results/ACM_ITSDT/ep060-loss3.042-val_loss6.144.pth",
    ...
    def generate(self, onnx=False):
        self.net    =ACMBody(self.num_classes, 's')#STNetwork(self.num_classes, num_frame=5)
    ...
    def detect_image(self, image_id, images, results):
        ...
        image_shape = np.array(np.shape(images)[0:2])
        #---------------------------------------------------------#
...
if __name__ == "__main__":
    ...
    if map_mode == 0 or map_mode == 1:
        ...
        with open(os.path.join(temp_save_path, 'eval_results.json'),"w") as f:
            ...
            for image_id in tqdm(ids):
                ...
                results     = yolo.detect_image(image_id, image, results) #images
            json.dump(results, f)
    ...
    if map_mode == 0 or map_mode == 2:
        ...
        precision_str = '\t'.join(map(str, precision_50)) + '\t'
        # 写入文件
        with open('SMFNet_IRDST.txt', 'w') as file:
            file.write(precision_str)
        # with open('SMFNet_IRDST.txt', 'w') as file:
        #     file.write('\t'.join(map(str, precision_50)))
        print("Get map done.")
