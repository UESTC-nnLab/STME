...
class MAP_vid(object):
    ...
    def generate(self, onnx=False):
        self.net    = YoloBody(self.num_classes, 's')#STNetwork(self.num_classes, num_frame=5)
    ...
    def detect_image(self, image_id, images, results):
        ...
        # image=gaussian_noise(np.array(image))
        # image1= Image.fromarray(image)
        # image1.save("gaus.png")
        # image=jiaoyan_noise(np.array(image))
        ...
        '''添加噪声'''
        # pdb.set_trace()
        # image_data=[jiaoyan_noise(gaussian_noise(np.array(image))) for image in image_data]
        '''end'''
        # pdb.set_trace()
        # image=image_data[0]
        # image1= Image.fromarray(image)
