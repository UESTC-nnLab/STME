...
from vid_map_coco_ITSDT import get_history_imgs
import colorsys
import os
import time
...
class Pred_vid(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        #'/home/pengshuang/detect/SSTNet-main/logs/loss_2024_03_27_21_44_46_STNet/ep028-loss3.001-val_loss3.169.pth',#
        "model_path"        : 'logs/loss_2024_06_12_10_02_15/ep026-loss2.320-val_loss4.474.pth',#'/home/pengshuang/detect/SSTNet-main/logs/loss_2024_06_03_01_43_33_加入backbone进行预训练v7注意力/ep003-loss3.029-val_loss3.616.pth',#'/home/work/SSTNet/logs/IRDST_71.55.pth',
...
if __name__ == "__main__":
    ...
    if mode == "predict_all":
        ...
        dir_path = '/home/pengshuang/Public/ITDST/1/'#'/home/pengshuang/Public/IRDST/images/2/'#'/home/images/'
        ...
        for image in tqdm(images):
            ...
            r_image.save("SSTNet_ITDST/pred_{}.jpg".format(i))
            i=i+1
        ...
        import numpy as np
        from tqdm import tqdm
        dir_path = '/home/pengshuang/Public/IRDST/images/1/'#'/home/images/'
        images = os.listdir(dir_path)
        images.sort(key=lambda x:int(x[:-4]))
        list_img = []
        for image in tqdm(images):
        ...
        outfile = cv2.VideoWriter("./myoutput.avi", fourcc, 5, (720, 480), True)    #大小必须和图片大小一致,且所以图片大小必须一致   -- photo_resize.py      
