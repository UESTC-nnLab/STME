...
if __name__ == "__main__":
    ...
    model = STNetwork(num_classes=1, num_frame=5) #5
    ...
    if True:
        ...
        train_dataset = seqDataset(train_annotation_path, input_shape[0], 5, 'train') #5
        val_dataset = seqDataset(val_annotation_path, input_shape[0], 5, 'val') #5
